...
Period: the fifty-sixth use of the analyse skill, on
...
- The ordinal collided while this retro was being written about the ordinal
  colliding. It was filed as the fifty-fourth, main took that number for a
  retro refiled under it for the same reason an hour earlier, and this is
  now the fifty-sixth. Two collisions in one day on one skill, and the
  second happened inside the record of the first.
