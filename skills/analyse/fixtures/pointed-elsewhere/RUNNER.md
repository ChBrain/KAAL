<!-- generated by kaal runner analyse pointed-elsewhere; edit the skill or the fixture, then regenerate -->

# Runner: analyse on pointed-elsewhere
...
I am pointing you at a directory. It holds a small command line tool that a
colleague wrote and nobody has touched in a year. Read it and tell me what
somebody adopting it cannot do today.
````
