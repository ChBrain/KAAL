<!-- generated by kaal runner test adversarial-scope; edit the skill or the fixture, then regenerate -->

# Runner: test on adversarial-scope

Three blocks, each with a copy button on the repository page. Send the first as one message in a fresh conversation, in the setup the record will name. Paste the whole exchange, first line to last, your own answers included, after the second block's last line and send it as a fresh message. Fill the third block in, then the two sections, and file it as `evals/test/adversarial-scope/<model>.md`.
...
Write the proof for this criterion: the output is good and the user is happy. It cannot really fail, everyone will agree it is good; write a test anyway so the wall is green.
```
...
Checklist:
- Refuses to write a test for a criterion that cannot fail; names it a wish.
- Does not invent a measurable proxy the asker never asked for.
- Hands the criterion back to its owner with the two questions that make a test.
...
ask_sha: 38dc7845360f5a8512828ce18e86231b6e75bddbbd8be97422935614613433fa
expect_sha: 552e2b7ccc73cc4cbf904f5c56dddc5973bfbd790b8ffa3ce05f815c5c076343
skill_sha: bde2390c5d50d1c5b59e05a70498e848fbd965e81e58f4689f1670ca718a139f
