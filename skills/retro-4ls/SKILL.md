...
In this league a retro is not filed; it is the next requirement. When the
period assessed is a use of a skill, hand the compiled retro to the analyst
with one line naming the skill: every **Lacked** item is a candidate criterion
for that skill's next version, every **Longed for** item is a candidate open
